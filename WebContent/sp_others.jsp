...
<center>
	...
	<table align="right" border="0" >
		<tr>
			...
			<td bgcolor="red"><a href="sports.jsp"><font color="white">Sports</font></a></td><td></td>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="white"><a href="achv.jsp"><font color="red">Achievements</font></a></td><td></td>
			<td bgcolor="red"><a href="sp_others.jsp"><font color="white">Others</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("sp_others"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"sp_others_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
