...
<center>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="red"><a href="achv.jsp"><font color="white">Achievements</font></a></td><td></td>
			<td bgcolor="white"><a href="sp_others.jsp"><font color="red">Others</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("sp_achv"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"achiewments_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
