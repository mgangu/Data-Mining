...
<center>
	...
	<table align="left" border="0" >
		<tr>
			...
			<td bgcolor="red"><a href="science.jsp"><font color="white">Science</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("tech_science"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"science_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
