...
<center>
	...
	<table align="left" border="0" >
		<tr>
			...
			<td bgcolor="red"><a href="pol_contro.jsp"><font color="white">Controversial</font></a></td><td></td>
			 <td bgcolor="white"><a href="pol_others.jsp"><font color="red">Others</font></a></td><td></td> 
			<!-- <td bgcolor="white"><a href="enter.jsp"><font color="red">Entertainment</font></a></td><td></td>
			<td bgcolor="white"><a href="tech.jsp"><font color="red">Technology</font></a></td><td></td>
			<td bgcolor="white"><a href="index.html"><font color="red">Log Out</font></a></td><td></td> -->
		</tr>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("pol_contr"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"pol_contro_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
