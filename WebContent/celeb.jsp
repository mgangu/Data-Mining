...
<center>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="red"><a href="celeb.jsp"><font color="white">Celebrations</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("ent_celeb"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"celebrations_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
