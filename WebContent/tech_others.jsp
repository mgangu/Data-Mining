...
<center>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="white"><a href="computer.jsp"><font color="red">Computer</font></a></td><td></td>
			<td bgcolor="white"><a href="science.jsp"><font color="red">Science</font></a></td><td></td>
			 <td bgcolor="red"><a href="tech_others.jsp"><font color="white">Others</font></a></td><td></td> 
			<!-- <td bgcolor="white"><a href="enter.jsp"><font color="red">Entertainment</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("tech_others"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"tech_others_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
