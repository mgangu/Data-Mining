...
<center>
	...
	<table align="left" border="0" >
		<tr>
			...
			<td bgcolor="red"><a href="trades.jsp"><font color="white">Trades</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("bs_trades"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"exploreDataTrades.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
