...
<center>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="red"><a href="pol_parl.jsp"><font color="white">Parliament</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("pol_parl"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"pol_parl_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
