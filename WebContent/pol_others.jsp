...
<center>
	...
	<table align="right" border="0" >
		<tr>
			...
			<td bgcolor="red"><a href="politics.jsp"><font color="white">Politics</font></a></td><td></td>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="white"><a href="pol_parl.jsp"><font color="red">Parliament</font></a></td><td></td>
			<td bgcolor="white"><a href="pol_contro.jsp"><font color="red">Controversial</font></a></td><td></td>
			 <td bgcolor="red"><a href="pol_others.jsp"><font color="white">Others</font></a></td><td></td> 
			<!-- <td bgcolor="white"><a href="enter.jsp"><font color="red">Entertainment</font></a></td><td></td>
			<td bgcolor="white"><a href="tech.jsp"><font color="red">Technology</font></a></td><td></td>
			<td bgcolor="white"><a href="index.html"><font color="red">Log Out</font></a></td><td></td> -->
		</tr>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("pol_others"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"pol_others_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
