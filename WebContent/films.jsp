...
<center>
	...
	<table align="left" border="0" >
		<tr>
			<td bgcolor="white"><a href="celeb.jsp.jsp"><font color="red">Celebrations</font></a></td><td></td>
			<td bgcolor="red"><a href="films.jsp"><font color="white">Films</font></a></td><td></td>
...
//	out.println(al.get(i));
	...
	if(category_code.equals("ent_films"))
	{
		...
		if(scanned_data.hasNextLine())
		{
			...
			out.println("<a href=\"films_data.jsp?p="+fileName+"\">"+first_line+"</a>");
		}
		out.println();
		out.println("<br />");
		out.println("<br />");
